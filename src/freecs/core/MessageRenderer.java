...
public class MessageRenderer {
	 ...
	 */
   public static String renderTemplate (MessageState msgState, String msgTpl) {
	  return renderTemplate (msgState, msgTpl, msgTpl.equals ("list.users") ? false : true);
   }
   public static String renderTemplate (MessageState msgState, String msgTpl, boolean addBreak) {
	  if (msgTpl == null) 
          return null;
	...
	*/
	private static String evalVariable (MessageState msgState, String token) {
        String val = null;
            ...
            if (cu != null && pos == -1) { // TOKEN for the username
                ...
                if (tok.startsWith ("name")) {
                            ...
                            for (int s = 0; s< svp.length; s++) {   
                                ...
                                try {   
                                    if (svp[s].canConvert(msgState))
                                         awayMessage =  svp[s].convertAwaymessage(msgState, convert.toString(), cu);   
                                } catch (Exception e) {   
                    ...
                    TemplateSet ts = msgState.sender == null 
                        ? TemplateManager.mgr.getTemplateSet()
                        : msgState.sender.getTemplateSet();
                    val = renderTemplate(msgState, ts.getMessageTemplate("constant.linkedName"), false);
                        ...
                        if (Server.srv.USE_PLUGINS){
                            ...
                            if (svp !=null) {   
                                for (int s = 0; s<svp.length; s++) {   
                                    ...
                                    try { 
                                        if (svp[s].canConvert(msgState))
                                            theme = svp[s].convertGrouptheme(msgState, convert.toString());   
                                    } catch (Exception e) {   
                                        Server.debug (svp[s], "catched exception from plugin", e, Server.MSG_ERROR, Server.LVL_MINOR);   
                                    }   
                                    if (theme != null)
                        ...
                        if (Server.srv.USE_PLUGINS){
                            ...
                            if (svp !=null) {   
                                for (int s = 0; s<svp.length; s++) {   
                                    ...
                                    try {   
                                       if (svp[s].canConvert(msgState))
                                           grp = svp[s].convertGroupname(msgState, convert.toString());   
                                    } catch (Exception e) {   
                                       Server.debug (svp[s], "catched exception from plugin", e, Server.MSG_ERROR, Server.LVL_MINOR);   
                                    }   
                                    if (grp != null)
                    ...
                    if (cu.conn.peerAddress != null) {
                        val = cu.conn.peerAddress.getCanonicalHostName();
                    }
                    if (val == null)
                        val = "";
                    ...
                    if (cu.conn.clientAddress != null) {
                        val = cu.conn.clientAddress.getCanonicalHostName();
                    }
                    if (val == null)
                        val = "";
                } else if (tok.startsWith ("clientip")) {
                    val = cu.conn.clientIp;
                    if (val == null)
                        val = "";
            ...
            if (pos == -1) {
                ...
                if (tok.startsWith("group")
                    ...
                    if (!sb_val.equals(convert)) {
                        ...
                        } else encode=tok.startsWith("targetgroup");
                    }
                }
            } else if (cg != null) {
                tok = tok.substring(pos+1);
                if (tok.startsWith ("theme")) {              	
                    ...
                    if (msgState.sender != null && msgState.sender.hasRight(IUserStates.ROLE_VIP)) {
                        User u = UserManager.mgr.getUserByName(cg.getOpener());
                        if (u != null){
           ...
           || tok.startsWith ("result")) {
                    ...
                    if (Server.srv.USE_PLUGINS){
                        ...
                        if (svp !=null) {   
                            for (int s = 0; s<svp.length; s++) {   
                                ...
                                try {   
                                    if (svp[s].canConvert(msgState))
                                        message = svp[s].convertMessage(msgState, convert.toString(), toupper);   
                                } catch (Exception e) {   
                                    Server.debug (svp[s], "catched exception from plugin", e, Server.MSG_ERROR, Server.LVL_MINOR);   
                                }   
                                if (message != null)
                ...
                if (Server.srv.USE_PLUGINS){
                    ...
                    if (svp !=null) {   
                        for (int s = 0; s<svp.length; s++) {   
                            ...
                            try {  
                                if (svp[s].canConvert(msgState))
                                    reason = svp[s].convertReason(msgState, convert.toString());   
                            } catch (Exception e) {   
                                Server.debug (svp[s], "catched exception from plugin", e, Server.MSG_ERROR, Server.LVL_MINOR);   
                            }   
                            if (reason != null)
                ...
                if (Server.srv.USE_PLUGINS){
                    ...
                    if (svp !=null) {   
                        for (int s = 0; s<svp.length; s++) {   
                            ...
                            try {   
                                if (svp[s].canConvert(msgState))
                                    param = svp[s].convertParam(msgState, convert.toString());   
                            } catch (Exception e) {   
                                Server.debug (svp[s], "catched exception from plugin", e, Server.MSG_ERROR, Server.LVL_MINOR);   
                            }   
                            if (param != null)
                ...
                for (int i = 0; i < msgState.usrList.length-1; i++) {
                    ...
                    if (curr instanceof User) {
                        if (!useTpl) {
                            ...
                            sb.append (renderTemplate(msgState,ts.getMessageTemplate("constant.userListItem"), false));
                        }
                    } else
            ...
            if (item instanceof User) {
                if (ts.getMessageTemplate("constant.userListItem")==null) {
                    ...
                    val = renderTemplate(msgState, ts.getMessageTemplate("constant.userListItem"), false);
                    msgState.usercontext = u;
                }
            } else
                val = item.toString();
            ...
            if (msgTpl == null) {
                ...
                val = renderTemplate(msgState, msgTpl, false);
            }
        }
        if (val == null) 
            return (token);
        ...
        return renderValue (msgState, val, token.substring (pos).trim ()); 
    }
	 ...
	 */
    private static String renderValue (MessageState msgState, String val, String params) {
        ...
        if (prefix.indexOf("@") > -1) {
            prefix = renderTemplate (msgState, prefix.replace('@', '§'), false);
        }
        if (suffix.indexOf("@") > -1) {
            suffix = renderTemplate (msgState, suffix.replace('@', '§'), false);
        }
        sb.append (prefix);
        sb.append (val);
        sb.append (suffix);
